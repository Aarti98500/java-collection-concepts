...
public class ComparatorExample {
    ...
    public static void main(String[] args) {
        ...
        employeeList.add(new Employee("Aarti",100, 40000));
        employeeList.add(new Employee("Karan",100, 50000));
        employeeList.add(new Employee("Karan",100, 60000));
        employeeList.add(new Employee("Moin",500, 70000));
        employeeList.add(new Employee("Vikram",200, 80000));
        employeeList.add(new Employee("Komal",100, 90000));
